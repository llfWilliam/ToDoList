...
# Template: app
# Command: E:\Qt\6.5.3\mingw_64\bin\qmake.exe -o Makefile ToDoList.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: ToDoList.pro ../../../Qt/6.5.3/mingw_64/mkspecs/win32-g++/qmake.conf ../../../Qt/6.5.3/mingw_64/mkspecs/features/spec_pre.prf \
